...
Для 3+ групп алгоритм действий аналогичен: .
  ...
  1. Для проверки влияния категориального фактора на количественный .
    - разбиваем на группы по категориям и сопоставляем по среднему уровню эти показатели .
    - проверяем нулевую гипотезу о равенстве статистических показателей .
  2. Если нулевая гипотеза подтверждена - значит этот фактор не влияет на количественный показатель .
  3. Если нулевая гипотеза отклонена - этот категориальный показатель стоит включить в модель .

  1. Для проверки влияния количественного показателя на категориальный .
    - разбиваем выборку на группы по категореальному показателю .
    - проверяем гипотезу о равенстве целевых показателей в группах .
